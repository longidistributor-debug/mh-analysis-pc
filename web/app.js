...
function buildSignal(sym,tf,c,m,s,dir,buyScore,sellScore,ranked){
  ...
  const structuralTp1Obj=chooseObjectiveBounded(entry,allOpp,desiredTp1,dir,Math.max(model.noise*.35,profile.tp1Floor*.25),profile.tp1Cap),structuralTp1=structuralTp1Obj??(dir==='BUY'?entry+desiredTp1:entry-desiredTp1);
