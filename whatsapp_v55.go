...
// V55 sends the final Enter through Chromium DevTools to the same persistent,
// logged-in WhatsApp WebView used by the visible WhatsApp tab; no second session
// or foreground desktop window is created for background delivery.
