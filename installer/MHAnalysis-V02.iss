...
[Setup]
; Same AppId = V.02 upgrades the existing V.01 installation in place.
...
OutputBaseFilename=MH Analysis V.02
...
VersionInfoDescription=MH Analysis V.02 Installer
